...
import ServiceSidebarSkeleton from './skeleton';

interface IServiceSidebarProps {
  selectedCategory?: TCategoryQuery;
}
export default function ServiceSidebar({ selectedCategory }: IServiceSidebarProps) {
  ...
  if (categoriesLoading) return <ServiceSidebarSkeleton />;
